...
# ZeroCut Gaming AI Run 102 - Project Recovery candidate.
# P0 scope: crash-safe project persistence, corrupted-state recovery, and interrupted-write recovery.
...
def save_state(state: dict):
    """Commit a validated project state atomically and maintain a last-known-good recovery copy."""
    with _STATE_LOCK:
